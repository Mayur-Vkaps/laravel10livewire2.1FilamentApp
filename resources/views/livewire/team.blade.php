                            ...
                            <div class="card bg-transparent border-0 text-center">
                                <div class="card-img">
                                    <img loading="lazy" decoding="async" src="{{ asset('storage/' . $team->image) }}"
                                        alt="Scarlet Pena" class="rounded w-100" width="300" height="332" style="object-fit: cover;width:100%;height:100%">
                                    <ul class="card-social list-inline">
                                        @if (!$team->fb_url == '')
                                        <li class="list-inline-item"><a target="_blank" class="facebook" href="{{ $team->fb_url }}"><i
                                            class="fab fa-facebook"></i></a>
                                </li>

                                        @endif
                                        @if (!$team->tw_url == '')
                                        <li class="list-inline-item"><a target="_blank" class="twitter" href="{{ $team->tw_url }}"><i
                                        ...
                                        @if (!$team->in_url == '')
                                        <li class="list-inline-item"><a target="_blank" class="instagram" href="{{ $team->in_url }}"><i
