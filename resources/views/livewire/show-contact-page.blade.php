            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a href="{{ route('showContact') }}">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <form action="#!">
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            <label for="exampleFormControlTextarea1" class="form-label">Write
                                                Message</label>
                                            <textarea class="form-control shadow-none @error('message') is-invalid @enderror" id="exampleFormControlTextarea1"
                                        ...
                                        <button class="btn btn-primary w-100" type="submit"
                                            wire:click.prevent="submit()">Send Message</button>
                                    </form>
                                </div>
                            </div>
