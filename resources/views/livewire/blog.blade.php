                            ...
                            <div class="col-md-6" data-aos="fade">
                                <article class="blog-post">
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <h2 class="h4"><a class="text-black" href="{{ route('showBlog',$article->id)}}">{{ $article->content}}</p> <a href="{{ route('showBlog',$article->id)}}" class="text-primary fw-bold" aria-label="Read the full article by clicking here">Read More</a>
                                    </div>
                                </article>
                            </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="widget widget-categories">
                        ...
                        <ul class="list-unstyled widget-list">
                            ...
                            <li><a href="#">{{ $category->name}} <small class="ml-auto">(1)</small></a>
                            </li>

                            @endforeach
                            @else
                            <h5>Categories Available</h5>
                    ...
                    <div class="widget">
                        ...
                        @foreach ($latestarticles as $key => $latestarticle)
                        <ul class="list-unstyled widget-list">
                            <li class="d-flex widget-post align-items-center">
                                <a class="text-black" href="{{ route('showBlog',$article->id)}}">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="h6 mb-0"><a class="text-black" href="blog-details.html">{{ $latestarticle->content}}</a></h5>
                        ...
                        @else
                        <h5>No Latest article Available</h5>
                        @endif
